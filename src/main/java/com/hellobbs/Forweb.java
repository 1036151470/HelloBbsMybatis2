...
public class Forweb {
    ...
    private static final String tablename = "forweb.";
    private static final String controllername = "/bbs_forweb";
    private static final String controllernamefor2 = "/bbs_forweb/";
