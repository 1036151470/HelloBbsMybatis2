...
@Controller
@Scope("prototype")
public class Forwindows {

    @Autowired
    SqlSession sqlSession;

    private static final String tablename = "forwindows.";
    private static final String controllername = "/bbs_forwindows";
    private static final String controllernamefor2 = "/bbs_forwindows/";
