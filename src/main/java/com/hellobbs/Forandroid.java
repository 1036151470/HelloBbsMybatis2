...
public class Forandroid {
    ...
    private static final String tablename = "forandroid.";
    private static final String controllername = "/bbs_forandroid";
    private static final String controllernamefor2 = "/bbs_forandroid/";
